...
// FNV-1a hash function for code deduplication
// A solid, fast hash with good distribution properties and low collision rate
export function hashCode(str: string): number {
  ...
  for (let i = 0; i < str.length; i++) {
    ...
    // Multiply by FNV_PRIME using Math.imul for proper 32-bit multiplication
...
export function ShaderPlayground({ initialExample }: ShaderPlaygroundProps) {
  ...
  const lastRunHashRef = useRef<number | null>();
