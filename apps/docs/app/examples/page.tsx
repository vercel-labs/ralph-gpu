  ...
  return (
    <div className="px-4 py-8 lg:px-8 lg:py-12 max-w-6xl mx-auto">
      <header className="mb-12">
        ...
        <p className="text-xl text-gray-10 max-w-2xl">
      ...
      <section className="mb-16">
        <h2 className="text-2xl font-semibold text-gray-12 mb-6">
          Tips for Shader Development
        </h2>
        
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="p-4 rounded-lg bg-gray-1 border border-gray-4">
            <h3 className="font-semibold text-gray-12 mb-2">🎨 UV Coordinates</h3>
          ...
          <div className="p-4 rounded-lg bg-gray-1 border border-gray-4">
            <h3 className="font-semibold text-gray-12 mb-2">⏱️ Time Animation</h3>
            <p className="text-gray-10 text-sm">
          ...
          <div className="p-4 rounded-lg bg-gray-1 border border-gray-4">
            <h3 className="font-semibold text-gray-12 mb-2">🔧 Debugging</h3>
            <p className="text-gray-10 text-sm">
          ...
          <div className="p-4 rounded-lg bg-gray-1 border border-gray-4">
            <h3 className="font-semibold text-gray-12 mb-2">📐 Aspect Ratio</h3>
            <p className="text-gray-10 text-sm">
      ...
      {/* Next Steps */}
      <section>
        <h2 className="text-2xl font-semibold text-gray-12 mb-6">Next Steps</h2>
        <div className="grid sm:grid-cols-2 gap-4">
          <a
            href="/concepts"
            className="p-6 rounded-lg bg-gray-1 border border-gray-4 hover:border-gray-5 transition-colors group"
          >
            <h3 className="font-semibold text-gray-12 mb-2 group-hover:text-blue-9 transition-colors">Core Concepts →</h3>
            <p className="text-gray-10 text-sm">
          ...
          <a
            ...
            className="p-6 rounded-lg bg-gray-1 border border-gray-4 hover:border-gray-5 transition-colors group"
          >
            <h3 className="font-semibold text-gray-12 mb-2 group-hover:text-blue-9 transition-colors">API Reference →</h3>
            <p className="text-gray-10 text-sm">
