...
export default function ExamplePage({ params }: PageProps) {
  ...
  return (
    <div className="flex flex-col h-screen bg-black">
      ...
      <header className="flex items-center h-16 px-4 bg-black border-b border-gray-4 shrink-0">
        <div className="flex items-center gap-3">
          <Link
            href="/examples"
            className="text-gray-9 hover:text-gray-12 transition-colors flex items-center gap-1 text-[13px]"
          >
          ...
          <span className="text-gray-9 text-[12px] hidden md:block max-w-sm truncate">
            — {example.description}
          </span>
        </div>
      </header>
