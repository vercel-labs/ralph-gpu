    ...
    <div className="max-w-4xl">
      ...
      <section className="mb-12">
        ...
        <pre className="rounded-lg bg-zinc-900 p-4 text-sm text-zinc-300 border border-zinc-800 overflow-x-auto mb-4">
          <code>{`const target = ctx.target(width?, height?, options?)`}</code>
        </pre>
...
const hdrPixels = hdrTarget.readPixels() // Float32Array`}</code>
          </pre>
        </div>
